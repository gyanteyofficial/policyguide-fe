...
export class InsuranceCategoriesComponent {
  categories = [
    ...
    { id: 'car', name: 'Car Insurance', icon: '🚗', badge: '35% Cheaper', badgeColor: 'orange', desc: 'Comprehensive & third-party covers', starting: '₹2,072/year', popular: false, link: null },
    { id: 'two-wheeler', name: 'Two Wheeler Insurance', icon: '🏍️', badge: 'Waiver of Premium', badgeColor: 'purple', desc: 'Ride safe with full coverage', starting: '₹714/year', popular: false, link: null },
    ...
    { id: 'travel', name: 'Travel Insurance', icon: '✈️', badge: 'New Launch', badgeColor: 'green', desc: 'Travel worry-free worldwide', starting: '₹350/trip', popular: false, link: null },
